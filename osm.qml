  ...
  <pipe>
    ...
    <rasterrenderer nodataColor="" alphaBand="-1" opacity="1" type="paletted" band="1">
      ...
      <colorPalette>
        ...
        <paletteEntry alpha="255" value="103" color="#d44a0a" label="103"/>
        <paletteEntry alpha="255" value="104" color="#b5a295" label="104"/>
        <paletteEntry alpha="255" value="105" color="#d4b40a" label="105"/>
      </colorPalette>
